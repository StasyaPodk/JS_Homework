...
for (course of coursesAndDurationArray){
    ...
    h1.innerHTML = `<h1 class = 'heading'>${course.title}</h1>`;
    p.innerHTML  =`<p class = 'description'> ${course.monthDuration} </p>`;
...
for (simpson of simpsons){
    ...
    h1.innerHTML = `<h1 class = 'name'>${simpson.name} ${simpson.surname} </h1>`;
    p.innerHTML  =`<p class = 'age'> ${simpson.age} лет. ${simpson.info} </p>`;
